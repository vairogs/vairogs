# Vairogs Functions: Handler - Features

This document lists all the classes and methods available in the Vairogs Functions: Handler package.
...
Example:
```php
use Vairogs\Functions\Handler\SkipErrorHandler;
